...
@Component({
  ...
  template: `
    <div class="page-container p-6 space-y-6 fade-in">
      <!-- Header -->
      <div class="relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white shadow-xl">
        <div class="absolute inset-0 bg-black/10"></div>
        <div class="relative z-10">
          <div class="flex items-center space-x-4">
            <div class="p-3 bg-white/20 rounded-full backdrop-blur-sm">
              <mat-icon class="text-2xl">domain</mat-icon>
            </div>
            <div>
              <h1 class="text-2xl font-bold">Society Management</h1>
              <p class="text-emerald-100 text-sm">Configure society information and settings</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form [formGroup]="societyForm" (ngSubmit)="onSubmit()">
            <div class="form-field-group two-column">
              <div class="form-field-container">
                ...
                <mat-form-field appearance="outline">
                  <input matInput formControlName="societyName" placeholder="Enter society name">
                </mat-form-field>
                <div class="form-error" *ngIf="societyForm.get('societyName')?.errors?.['required'] && societyForm.get('societyName')?.touched">
              ...
              <div class="form-field-container">
                ...
                <div class="form-error" *ngIf="societyForm.get('registrationNumber')?.errors?.['required'] && societyForm.get('registrationNumber')?.touched">
            ...
            <div class="form-field-group three-column">
              <div class="form-field-container">
                ...
                <mat-form-field appearance="outline">
                  <input matInput [matDatepicker]="establishmentPicker" formControlName="establishmentDate" placeholder="Select date">
                  <mat-datepicker-toggle matIconSuffix [for]="establishmentPicker"></mat-datepicker-toggle>
                  <mat-datepicker #establishmentPicker></mat-datepicker>
                </mat-form-field>
                <div class="form-error" *ngIf="societyForm.get('establishmentDate')?.errors?.['required'] && societyForm.get('establishmentDate')?.touched">
                  Establishment date is required
                </div>
              </div>

              <div class="form-field-container">
                <label class="form-label required">Society Type</label>
                <mat-form-field appearance="outline">
                  <mat-select formControlName="societyType">
                    <mat-option value="credit">Credit Society</mat-option>
                    <mat-option value="housing">Housing Society</mat-option>
                    <mat-option value="cooperative">Cooperative Society</mat-option>
                    <mat-option value="consumer">Consumer Society</mat-option>
                  </mat-select>
                </mat-form-field>
                <div class="form-error" *ngIf="societyForm.get('societyType')?.errors?.['required'] && societyForm.get('societyType')?.touched">
                  Society type is required
                </div>
              </div>
              ...
              <div class="form-field-container">
                ...
                <div class="form-error" *ngIf="societyForm.get('status')?.errors?.['required'] && societyForm.get('status')?.touched">
                  Status is required
                </div>
              </div>
            </div>
          ...
          <form [formGroup]="societyForm">
            <div class="form-field-group">
              <div class="form-field-container">
                ...
                <div class="form-error" *ngIf="societyForm.get('address')?.errors?.['required'] && societyForm.get('address')?.touched">
                  Address is required
                </div>
              </div>
            </div>
            ...
            <div class="form-field-group three-column">
              <div class="form-field-container">
                ...
                <div class="form-error" *ngIf="societyForm.get('phoneNumber')?.errors?.['required'] && societyForm.get('phoneNumber')?.touched">
              ...
              <div class="form-field-container">
                ...
                <div class="form-error" *ngIf="societyForm.get('email')?.errors?.['required'] && societyForm.get('email')?.touched">
                  Email is required
                </div>
                <div class="form-error" *ngIf="societyForm.get('email')?.errors?.['email'] && societyForm.get('email')?.touched">
      ...
      <div class="form-section">
        ...
        <div class="form-section-content">
          <form [formGroup]="societyForm">
            <div class="form-field-group two-column">
              <div class="form-field-container">
                <label class="form-label required">Share Capital (₹)</label>
                <mat-form-field appearance="outline">
                  <input matInput type="number" formControlName="shareCapital" placeholder="0.00">
                </mat-form-field>
                <div class="form-error" *ngIf="societyForm.get('shareCapital')?.errors?.['required'] && societyForm.get('shareCapital')?.touched">
                  Share capital is required
                </div>
              </div>

              <div class="form-field-container">
                <label class="form-label required">Reserve Fund (₹)</label>
                <mat-form-field appearance="outline">
                  <input matInput type="number" formControlName="reserveFund" placeholder="0.00">
                </mat-form-field>
                <div class="form-error" *ngIf="societyForm.get('reserveFund')?.errors?.['required'] && societyForm.get('reserveFund')?.touched">
            ...
            <div class="form-actions">
              ...
              <button mat-raised-button color="primary" type="submit" [disabled]="societyForm.invalid" (click)="onSubmit()">
  ...
  styles: [`
    ...
    .form-field-container:hover .form-label {
      color: #3b82f6;
...
export class SocietyComponent implements OnInit {
  ...
  initializeForm() {
    this.societyForm = this.fb.group({
      ...
      email: ['', [Validators.required, Validators.email]],
      website: [''],
      shareCapital: ['', [Validators.required, Validators.min(0)]],
      reserveFund: ['', [Validators.required, Validators.min(0)]],
      panNumber: [''],
      gstNumber: ['']
    });
  }
